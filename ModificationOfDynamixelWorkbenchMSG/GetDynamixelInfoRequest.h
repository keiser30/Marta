...
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::GetDynamixelInfoRequest_<ContainerAllocator>& v)
  {
		s << indent << "dxl_id: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.dxl_id);
		s << indent << "port: ";
