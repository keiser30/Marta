...
#include "../include/my_dynamixel_workbench_single_manager/single_dynamixel_controller.h"
...
bool SingleDynamixelController::sendCommandMsg(std::string cmd, uint8_t dxl, std::string addr, int64_t value)
{
